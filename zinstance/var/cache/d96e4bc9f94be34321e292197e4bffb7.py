# -*- coding: utf-8 -*-
__filename = '/home/kali/plone5_12_env/buildout-cache/eggs/cp27mu/z3c.form-3.7.1-py2.7.egg/z3c/form/browser/text_input.pt'
...
def initialize(modules, nothing, tales, zope_version_4_8_7_):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<_ast.Dict object at 0x7f8b16ab4e50> name=None at 7f8b16ab4b90> -> __attrs_140235357506832
            __attrs_140235357506832 = _static_140235357507152
            __append(u'\n    ')

            # <Static value=<_ast.Dict object at 0x7f8b148e3c90> name=None at 7f8b148e3750> -> __attrs_140235319832848
            __attrs_140235319832848 = _static_140235322047632

            # <input ... (0:0)
            # --------------------------------------------------------
            __append(u'<input')

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319669776
            __default_140235319669776 = _DEFAULT_MARKER

            # <Substitution u'view/id' (7:30)> -> __attr_id
            __token = 329
            try:
                __zt_tmp = __attrs_140235319832848
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319669840
            __default_140235319669840 = _DEFAULT_MARKER
            ...
            __attr_name = _static_140235435449424('path', u'view/name', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            __attr_name = __quote(__attr_name, '"', '&quot;', u'', _DEFAULT_MARKER)
            if (__attr_name is not None):
                __append((u' name="%s"' % __attr_name))

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319669328
            __default_140235319669328 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319671248
            __default_140235319671248 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319669520
            __default_140235319669520 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319670416
            __default_140235319670416 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319671056
            __default_140235319671056 = _DEFAULT_MARKER
            ...
            __attr_readonly = _static_140235435449424('path', u'view/readonly', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319672208
            __default_140235319672208 = _DEFAULT_MARKER
            ...
            __attr_alt = _static_140235435449424('path', u'view/alt', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            __attr_alt = __quote(__attr_alt, '"', '&quot;', u'', _DEFAULT_MARKER)
            if (__attr_alt is not None):
                __append((u' alt="%s"' % __attr_alt))

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320031696
            __default_140235320031696 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320031888
            __default_140235320031888 = _DEFAULT_MARKER
            ...
            __attr_accesskey = _static_140235435449424('path', u'view/accesskey', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320030288
            __default_140235320030288 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320030160
            __default_140235320030160 = _DEFAULT_MARKER
            ...
            __attr_maxlength = _static_140235435449424('path', u'view/maxlength', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320032144
            __default_140235320032144 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320032272
            __default_140235320032272 = _DEFAULT_MARKER
            ...
            __attr_value = _static_140235435449424('path', u'view/value', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            __attr_value = __quote(__attr_value, '"', '&quot;', u'', _DEFAULT_MARKER)
            if (__attr_value is not None):
                __append((u' value="%s"' % __attr_value))
            __append(u' type="text"')

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320031440
            __default_140235320031440 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320029648
            __default_140235320029648 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320031632
            __default_140235320031632 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320029712
            __default_140235320029712 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320032784
            __default_140235320032784 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319834000
            __default_140235319834000 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319833488
            __default_140235319833488 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319834576
            __default_140235319834576 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319834704
            __default_140235319834704 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319834832
            __default_140235319834832 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319835280
            __default_140235319835280 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319835152
            __default_140235319835152 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319836112
            __default_140235319836112 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319835472
            __default_140235319835472 = _DEFAULT_MARKER
            ...
            __attr_onselect = _static_140235435449424('path', u'view/onselect', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319833104
            __default_140235319833104 = _DEFAULT_MARKER
            ...
            __attr_placeholder = _static_140235435449424('path', u'view/placeholder', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235319835984
            __default_140235319835984 = _DEFAULT_MARKER
            ...
            __attr_autocapitalize = _static_140235435449424('path', u'view/autocapitalize', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))

# -*- coding: utf-8 -*-
__filename = '/home/kali/plone5_12_env/buildout-cache/eggs/cp27mu/z3c.form-3.7.1-py2.7.egg/z3c/form/browser/textarea_input.pt'
...
def initialize(modules, nothing, tales, zope_version_4_8_7_):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<_ast.Dict object at 0x7f8b149a1b10> name=None at 7f8b149a1450> -> __attrs_140235322825360
            __attrs_140235322825360 = _static_140235322825488
            __append(u'\n')

            # <Static value=<_ast.Dict object at 0x7f8b149a3ed0> name=None at 7f8b149a1890> -> __attrs_140235322090960
            __attrs_140235322090960 = _static_140235322834640

            # <textarea ... (0:0)
            # --------------------------------------------------------
            __append(u'<textarea')

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235323416272
            __default_140235323416272 = _DEFAULT_MARKER

            # <Substitution u'view/id' (7:22)> -> __attr_id
            __token = 245
            try:
                __zt_tmp = __attrs_140235322090960
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235323414864
            __default_140235323414864 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235322490000
            __default_140235322490000 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235322487952
            __default_140235322487952 = _DEFAULT_MARKER
            ...
            __attr_cols = _static_140235435449424('path', u'view/cols', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            __attr_cols = __quote(__attr_cols, '"', '&quot;', u'', _DEFAULT_MARKER)
            if (__attr_cols is not None):
                __append((u' cols="%s"' % __attr_cols))

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320877456
            __default_140235320877456 = _DEFAULT_MARKER
            ...
            __attr_rows = _static_140235435449424('path', u'view/rows', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))
            __attr_rows = __quote(__attr_rows, '"', '&quot;', u'', _DEFAULT_MARKER)
            if (__attr_rows is not None):
                __append((u' rows="%s"' % __attr_rows))

            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320877520
            __default_140235320877520 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320877328
            __default_140235320877328 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320879504
            __default_140235320879504 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320879696
            __default_140235320879696 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320878480
            __default_140235320878480 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320877136
            __default_140235320877136 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320879440
            __default_140235320879440 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320881104
            __default_140235320881104 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320878992
            __default_140235320878992 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320878672
            __default_140235320878672 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235320880976
            __default_140235320880976 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235322036688
            __default_140235322036688 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357506448
            __default_140235357506448 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357504080
            __default_140235357504080 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357506960
            __default_140235357506960 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357505744
            __default_140235357505744 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357506896
            __default_140235357506896 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357505488
            __default_140235357505488 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357506192
            __default_140235357506192 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357505680
            __default_140235357505680 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235357505808
            __default_140235357505808 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7f8b1e8fff10> -> __default_140235322824784
            __default_140235322824784 = _DEFAULT_MARKER

            # <Value u'view/value' (33:16)> -> __cache_140235322825232
            __token = 1321
            try:
                __zt_tmp = __attrs_140235322090960
            except get('NameError', NameError):
            ...
            __cache_140235322825232 = _static_140235435449424('path', u'view/value', econtext=econtext)(_static_140235435450064(econtext, __zt_tmp))

            # <BinOp left=<Value u'view/value' (33:16)> op=<class 'chameleon.nodes.Is'> right=<Symbol value=<DEFAULT> at 7f8b1e8fff10> at 7f8b149a1dd0> -> __condition
            __expression = __cache_140235322825232
            ...
            if __condition:
                ...
                __content = __cache_140235322825232

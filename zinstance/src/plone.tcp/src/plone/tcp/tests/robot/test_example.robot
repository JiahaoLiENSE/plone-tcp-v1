...
#
#  $ bin/test -s plone.tcp -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plone.tcp.testing.PLONE_TCP_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/tcp/tests/robot/test_example.robot
#
